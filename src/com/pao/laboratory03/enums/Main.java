    ...
    public static void main(String[] args) {
        ...
        for (Priority priority : Priority.values()) {
            System.out.println(priority.getEmoji() + " " + priority.name()
                    + " (level=" + priority.getLevel() + ", color=" + priority.getColor() + ")");
        }
        ...
        System.out.println("Priority.valueOf(\"HIGH\") = " + parsed);

        System.out.println("\n=== Comparare enum ===");
        System.out.println("HIGH == HIGH? " + (Priority.HIGH == parsed));
        System.out.println("HIGH == LOW? " + (Priority.HIGH == Priority.LOW));

        System.out.println("\n=== name() și ordinal() ===");
        for (Priority priority : Priority.values()) {
            System.out.println(priority + ": name=" + priority.name() + ", ordinal=" + priority.ordinal());
        }
    }
}
