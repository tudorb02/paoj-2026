            ...
            try {
                switch (option) {
                    ...
                    case "2":
                        ...
                        System.out.print("Materie (" + subjectNames() + "): ");
                    ...
                    case "5":
                        ...
                        for (Map.Entry<Subject, Double> entry : service.getAveragePerSubject().entrySet()) {
                            System.out.printf(Locale.US, "%s: %.2f%n", entry.getKey().name(), entry.getValue());
                        }
                        break;
